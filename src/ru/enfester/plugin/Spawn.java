    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (player.hasPermission("enfester.admin")) {
            if (command.getName().equalsIgnoreCase("setspawn")) {
                ...
                plugin.getConfig().set("map.spawn.world", player.getWorld());
            ...
            if (command.getName().equalsIgnoreCase("setadminshop")) {
                ...
                plugin.getConfig().set("map.adminshop.world", player.getWorld());
                ...
                plugin.buildConfig();
                player.sendMessage(ChatColor.GREEN + "Точка магазина установлена!");
                return true;
            }
        } else {
